                  ...
                  <tr key={run.id}>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm">
                      <span className={`px-2 py-1 text-xs rounded ${
                        run.status === 'approved' ? 'bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-300' :
                        run.status === 'draft' ? 'bg-yellow-100 dark:bg-yellow-900/40 text-yellow-800 dark:text-yellow-300' :
